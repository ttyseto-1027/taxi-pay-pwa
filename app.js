...
function totals(entries=currentEntries()){
  ...
  const completedStandardShifts=entries.filter(e=>entryTimeInfo(e).work>=rule.shiftMinutes).length;
  ...
  return {gross,net,revenue,c,premium,model,completedStandardShifts,accidentFree,violationFree,allowances,paidLeavePay,grossPay,social,incomeTax,deductions,takeHome:grossPay-deductions};
}
