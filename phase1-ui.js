...
function closeMenu(){if(menu)menu.hidden=true;if(overlay)overlay.hidden=true;document.body.classList.remove('menu-open');openBtn?.setAttribute('aria-expanded','false');}
...
new MutationObserver(()=>{if(document.body.classList.contains('auth-pending'))closeMenu();}).observe(document.body,{attributes:true,attributeFilter:['class']});
