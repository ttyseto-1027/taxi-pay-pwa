(() => {
  ...
  const I=window.TaxiPayInlineDiagnostic; I?.add('V11-BOOT-001','boot.js を開始しました。');
  ...
  import('./firebase-auth.js?v=20260727-11').then(mod=>{ I?.add('V11-MODULE-OK','firebase-auth.js を読み込みました。');
